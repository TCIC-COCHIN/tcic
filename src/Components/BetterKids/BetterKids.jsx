...
import "./BetterKids.css";
import poster from "../../assets/images/img3.jpg"; // Replace with your BetterKids poster image path
...
const BetterKids = () => {
  ...
  return (
    <div className="betterkids-page">
      <div className="poster-container">
        <img
          src={poster}
          alt="BetterKids Program Poster"
          className="poster"
        />
      </div>
