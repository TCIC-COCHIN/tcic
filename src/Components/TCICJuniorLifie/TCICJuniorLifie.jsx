...
import "./TCICJuniorLifie.css";
import poster from "../../assets/images/img2.jpg"; // Replace with your TCIC Junior Lifie poster image path
import payImage from "../../assets/images/pay1.jpg"; // Replace with your payment image path

const TCICJuniorLifie = () => {
  ...
  return (
    <div className="tcic-junior-lifie-page">
      <div className="poster-container">
        <img
          src={poster}
          alt="TCIC Junior Lifie Poster"
          className="poster"
        />
      </div>
...
export default TCICJuniorLifie;
